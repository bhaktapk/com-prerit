...
<asp:Content ContentPlaceHolderID="linkContent" runat="server">
    <link rel="canonical" href="<%= new Uri(Request.Url, Url.Action(MVC.OpenId.Index())).AbsoluteUri %>" />
</asp:Content>
...
<asp:Content ContentPlaceHolderID="mainbarContent" runat="server">
    ...
    <p>
        <a href="<%= Url.Action(MVC.OpenId.Index()) %>" title="openid.realm value"><%= new Uri(Request.Url, Url.Action(MVC.OpenId.Index())).AbsoluteUri %></a>
    </p>
    ...
    <p>
        <a href="<%= Url.Action(MVC.OpenId.Xrds()) %>" title="X-XRDS-Location"><%= new Uri(Request.Url, Url.Action(MVC.OpenId.Xrds())).AbsoluteUri %></a>
    </p>
</asp:Content>
